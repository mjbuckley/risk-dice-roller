...
Examples of the forms the key pieces of data take are below. Should probably move somewhere else, like a notes file.
...
### The History Array Form From userRollInfo:
